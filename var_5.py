...
class LexicalAnalyzer():
    ...
    def q_1(self):
        ...
        if not symbol:
            self.index += 1
            return self.q_res({'number': int(self.buff, 5)})
...
class SyntaxAnalyzer():
    ...
    def syntaxAnalyzer(self, main_stack):
        ...
        self.q_0()
        return self.dec_to_base(self.stack[0])
    ...
    def r_8(self):
        ...
        self.main_stack += tmp
        self.writeToLog(f'\tGo\tfrom\tr_8 \tto\ts_0 \tpack 2:\t"F->(E)"')
        self.q_0()
...
try:
    ...
    stack = la1.lexicalAnalyzer('(4+2)+3*(4-3)')
    print(stack)
    sa1 = SyntaxAnalyzer()
